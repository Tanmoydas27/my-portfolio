    ...
    return (
      <>
        ...
        <div className="container ">
          <div
            className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start text-white"
          ...
          >
            <div className="row" style={{ width: "100%" }}>
              <div
                ...
                <div
                  style={{  fontSize: "22px",  marginLeft: "5%",  marginRight: "5%"}}>
                  <div style={{ marginTop: "30px" }}>
                    <p>
                      Hi Everyone, I am
                      <span className="yellow"> Tanmoy Das</span> from{" "}
                      <span className="yellow"> West Bengal, India.</span>I am
                      Currently a Final year B.Tech Computer Science And
                      Engineering Student In Sister Nivedita University.
                    </p>
                  </div>
                  <div>
                    <p>
                    ...
                    <ul style={{ fontSize: "22px", marginLeft: "30px" }}>
                      <li>Reading</li>
                      <li>Cricket</li>
                      <li>Listening Audio Story</li>
                    </ul>
                  </div>
                  <div style={{ textAlign: "center" }} className="yellow">
        ...
        <div className="container ">
          ...
          >
            <div className="row" style={{ width: "100%" }}>
              <h1 style={{ textAlign: "center" }}>
                Professonal <span className="yellow">Skillset</span>
              </h1>
              <div
                className="row"
                style={{ justifyContent: "center", paddingBottom: 50 }}
              >
          ...
          <div className="container ">
            <div  className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start text-white" style={{ marginTop: "2%", width: "100%" }} >
              <div className="row" style={{ width: "100%" }}>
                <h1 style={{ textAlign: "center" }}>
                  <span className="yellow">Tools</span> I Use
                </h1>
                <div
                  className="row"
                  style={{ justifyContent: "center", paddingBottom: 50 }}
                >
                  <div className="tech-icons col-md-2 col-4">
                    <img src="/windows.png" width={120} height={120}></img>
                  </div>
                  <div className="tech-icons col-md-2 col-4">
                    <svg
                      stroke="currentColor"
                  ...
                  <div className="tech-icons col-md-2 col-4">
                    <img src="/eclipse.png" width={80} height={80}></img>
                  </div>
                  <div className="tech-icons col-md-2 col-4">
                    <img src="/oracle.png" width={80} height={80}></img>
                  </div>
                </div>
              </div>
            </div>
