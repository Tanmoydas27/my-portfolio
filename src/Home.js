    ...
    return(
        <>
            <div className="container ">
                <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start text-white" style={{marginTop: '10%',width:'100%'}}>
                    <div className="row" style={{width:'100%'}}>
                        <div className="col-7 mt-4 px-8 " style={{width:'50%'}} >
                            <h1 className="heading" style={{paddingBottom: 15}}>
                                <h1>Hi There! <span className="wave" role="img" >  👋🏻</span></h1>
                            </h1>
                            <h1>
                                I'M
                                <strong style={{color:"yellow"}} > TANMOY DAS</strong>
                            </h1>
                        
                            <div style={{paddingTop:'50px',width:'100' }}>
                               <h2 style={{width:'100%',color:'yellowgreen'}}><TypeWritter /></h2> 
                            </div>
                        </div>
                        <br/>
                        <div className="col-5" style={{marginTop:'-5%'}}>
                            <div style={{marginLeft:'160px'}}>
                                <img src="/Images1.png" alt="Code in Table Images" width={500} height={500}></img>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div className="container" style={{minHeight:'200px' ,width:'100%',marginTop:'300px', marginBottom:'80px'}}>
                <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start text-white">
                    <div className="row" style={{width:'100%'}}>
                        <div className="col-md-8" >
                            <h1 style={{textAlign:'center'}} >LET ME <span className="yellow">INTRODUCE </span>MYSELF</h1>
                            <br/>
                            <br/>
                            <p className="home-about-body">I fell in love with programming and I have at least learnt something, I think… 🤷‍♂️
                                <br />
                                <br />
                                I am fluent in classics like
                                <i>
                                    <b className="yellow"> Java, Javascript . </b>
                                </i>
                                <br />
                                <br />
                                ...
                                <i>
                                    ...
                                    <b className="yellow"> AI & ML.</b>
                                </i>
                                <br />
                                <br />
                                Whenever possible, I also apply my passion for developing products with 
                                <b className="yellow">Node.js</b> and
                                <i>
                                    <b className="yellow"> Modern Javascript Library and Frameworks</b>
                                </i>
                                &nbsp; like
                                <i>
                                    <b className="yellow"> React.js, Express.js, Github .</b>
                                </i>
                            </p>

                        </div>
                        <div class="myAvtar col-md-4">
                            <div style={{marginLeft:'120px',marginTop:'20px' }}>
                                <img src="/dp.jpg" className="img-fluid" alt="avatar" style={{borderRadius:'30px'}}/>
                            </div>
                        </div>
